CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_funeral_exp (
	gid numeric(22,0),
	...
	veh_funeral_expenses_cov numeric(22,0),
	hb_funeral_expenses_cov numeric(22,0),
	reg_funeral_expenses_cov numeric(22,0),
	frf_funeral_expenses_cov numeric(22,0),
	loc_funeral_expenses_cov numeric(22,0),
	state varchar(30),
	limit_coverage numeric(22,0),
	limit_number numeric(22,0),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_funeral_exp DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_funeral_exp_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_funeral_exp ADD CONSTRAINT rt_mis_cov_ca_funeral_exp_gid PRIMARY KEY (gid);
