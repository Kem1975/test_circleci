CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_rental_reim_coll (
	gid numeric(22,0),
	...
	veh_rent_reimb_coll_cov numeric(22,0),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_rental_reim_coll DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_rental_reim_coll_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_rental_reim_coll ADD CONSTRAINT rt_mis_cov_ca_rental_reim_coll_gid PRIMARY KEY (gid);
