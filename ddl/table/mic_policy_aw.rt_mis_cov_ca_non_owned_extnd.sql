CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_non_owned_extnd (
	gid numeric(22,0),
	...
	non_owned_ext_cov numeric(22,0),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_non_owned_extnd DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_non_owned_extnd_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_non_owned_extnd ADD CONSTRAINT rt_mis_cov_ca_non_owned_extnd_gid PRIMARY KEY (gid);
