CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_liab_cl_discount (
	gid numeric(22,0),
	...
	veh_cov_ca_liab_discount numeric(22,0),
	liab_annual_premium numeric(22,0),
	liabpd_annual_premium numeric(22,0),
	loc_cov_ca_liab_discount numeric(22,0),
	...
	nol_cov_ca_liab_dscnt numeric(22,0),
	doc_cov_ca_liab_dscnt numeric(22,0),
	hba_cov_ca_liab_dscnt numeric(22,0),
	rgplt_cov_ca_liab_dscnt numeric(22,0),
	bi_each_person_limit numeric(22,0),
	auto_body_manu_csldis_cov numeric(22,0),
	comp_rt_manipulator varchar(512),
	comp_rt_unt_typ varchar(256),
	zip_code varchar(5)
);

ALTER TABLE mic_policy_aw.rt_mis_cov_ca_liab_cl_discount DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_liab_cl_discount_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_liab_cl_discount ADD CONSTRAINT rt_mis_cov_ca_liab_cl_discount_gid PRIMARY KEY (gid);
