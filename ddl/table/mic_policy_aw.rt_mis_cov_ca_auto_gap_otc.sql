CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_auto_gap_otc (
	gid numeric(22,0),
	...
	veh_auto_gap_otc_cov numeric(22,0),
	auto_gap_prem_factor numeric(22,0),
	otc_premium numeric(22,0),
	aslob varchar(8),
	...
	otc_annual_premium numeric(22,0),
	...
	otc_manual_premium numeric(22,0),
	period_number numeric(22,0),
	comp_rt_manipulator varchar(512),
	comp_rt_unt_typ varchar(256)
);

ALTER TABLE mic_policy_aw.rt_mis_cov_ca_auto_gap_otc DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_auto_gap_otc_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_auto_gap_otc ADD CONSTRAINT rt_mis_cov_ca_auto_gap_otc_gid PRIMARY KEY (gid);
