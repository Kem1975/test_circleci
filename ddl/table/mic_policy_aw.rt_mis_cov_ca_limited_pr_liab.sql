CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_limited_pr_liab (
	gid numeric(22,0),
	...
	lmt_prop_damage_liab_cov numeric(22,0),
	each_accident numeric(22,0),
	...
	dealer_transporter_plate numeric(22,0),
	aslob varchar(8),
	...
	zip_code varchar(15),
	loc_lmt_propdmg_liabcov numeric(22,0),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_limited_pr_liab DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_limited_pr_liab_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_limited_pr_liab ADD CONSTRAINT rt_mis_cov_ca_limited_pr_liab_gid PRIMARY KEY (gid);
