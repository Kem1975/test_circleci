CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_rental_reim_otc (
	gid numeric(22,0),
	...
	veh_rent_reimb_otc_cov numeric(22,0),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_rental_reim_otc DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_rental_reim_otc_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_rental_reim_otc ADD CONSTRAINT rt_mis_cov_ca_rental_reim_otc_gid PRIMARY KEY (gid);
