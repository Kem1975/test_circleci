CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_dealer_collision (
	gid numeric(22,0),
	...
	dealer_blanket_coll numeric(22,0),
	rep_auto_coll numeric(22,0),
	auto_held_coll numeric(22,0),
	state varchar(30),
	state_code varchar(2),
	total_value_amount numeric(22,0),
	total_rating_units numeric(22,0),
	tier_uk varchar(128),
	tier_no numeric(22,0),
	tier_min numeric(22,0),
	tier_max numeric(22,0),
	tier_amount numeric(22,0),
	loss_cost numeric(22,0),
	loss_cost_multiplier numeric(22,0),
	tier_rate numeric(22,0),
	non_fran_dealer_fact numeric(22,0),
	val_per_rating_unit numeric(22,0),
	adj_factor numeric(22,0),
	...
	rate_form_val_per_rate varchar(4000),
	...
	limited_collision_factor numeric(22,0),
	...
	est_total_value_amount numeric(22,0),
	period_number numeric(22,0),
	limited_coll_factor numeric(22,0),
	waiver_collision_factor numeric(22,0),
	comp_rt_manipulator varchar(512),
	comp_rt_unt_typ varchar(256)
);

ALTER TABLE mic_policy_aw.rt_mis_cov_ca_dealer_collision DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_dealer_collision_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_dealer_collision ADD CONSTRAINT rt_mis_cov_ca_dealer_collision_gid PRIMARY KEY (gid);
