CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_liab_bal_to_min (
	gid numeric(22,0),
	...
	volunteer_liab_bal_min numeric(22,0),
	blanket_liab_bal_min numeric(22,0),
	...
	social_risk_liab_bal_min numeric(22,0),
	...
	base_nol_bal_to_min_cov numeric(22,0),
	annl_prem_prior_sch_exp numeric(22,0),
	period_number numeric(22,0),
	othr_socl_liab_bal_to_min numeric(22,0),
	othr_socl_pd_bal_to_min numeric(22,0),
	othr_socl_liab_bal_to_mn numeric(22,0),
	othr_socl_pd_bal_to_mn numeric(22,0),
	csl_limit_code varchar(8),
	zip_code varchar(4),
	statistical_code varchar(3),
	zip_code_n varchar(8),
	comp_rt_manipulator varchar(512),
	comp_rt_unt_typ varchar(256)
);

ALTER TABLE mic_policy_aw.rt_mis_cov_ca_liab_bal_to_min DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_liab_bal_to_min_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_liab_bal_to_min ADD CONSTRAINT rt_mis_cov_ca_liab_bal_to_min_gid PRIMARY KEY (gid);
