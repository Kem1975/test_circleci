CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_medical_benefit (
	gid numeric(22,0),
	...
	veh_cov_ca_med_ben numeric(22,0),
	hired_auto_med_ben numeric(22,0),
	reg_plates_med_ben numeric(22,0),
	frf_cov_ca_med_ben numeric(22,0),
	loc_cov_ca_med_ben numeric(22,0),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_medical_benefit DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_medical_benefit_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_medical_benefit ADD CONSTRAINT rt_mis_cov_ca_medical_benefit_gid PRIMARY KEY (gid);
