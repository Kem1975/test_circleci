CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_ext_med_benft (
	gid numeric(22,0),
	...
	public_vehicle_factor numeric(22,0),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_ext_med_benft DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_ext_med_benft_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_ext_med_benft ADD CONSTRAINT rt_mis_cov_ca_ext_med_benft_gid PRIMARY KEY (gid);
