CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_auto_gap_coll (
	gid numeric(22,0),
	...
	veh_auto_gap_collision_cov numeric(22,0),
	auto_gap_prem_factor numeric(22,0),
	collision_premium numeric(22,0),
	aslob varchar(8),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_auto_gap_coll DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_auto_gap_coll_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_auto_gap_coll ADD CONSTRAINT rt_mis_cov_ca_auto_gap_coll_gid PRIMARY KEY (gid);
