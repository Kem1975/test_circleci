CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_extended_pip (
	gid numeric(22,0),
	...
	veh_cov_ca_ext_pip numeric(22,0),
	...
	frf_extended_pip_cov numeric(22,0),
	loc_cov_ca_ext_pip numeric(22,0),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_extended_pip DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_extended_pip_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_extended_pip ADD CONSTRAINT rt_mis_cov_ca_extended_pip_gid PRIMARY KEY (gid);
