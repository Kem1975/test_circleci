CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_pollution_liab (
	gid numeric(22,0),
	...
	polution_liab_cov numeric(22,0),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_pollution_liab DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_pollution_liab_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_pollution_liab ADD CONSTRAINT rt_mis_cov_ca_pollution_liab_gid PRIMARY KEY (gid);
