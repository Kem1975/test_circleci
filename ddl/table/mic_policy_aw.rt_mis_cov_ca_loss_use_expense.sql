CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_loss_use_expense (
	gid numeric(22,0),
	...
	loss_of_use_exp_cov numeric(22,0),
	state varchar(30),
	state_code varchar(2),
	amt_per_day numeric(22,0),
	max_amount numeric(22,0),
	manual_premium numeric(22,0),
	aslob varchar(8),
	csp_subline_code varchar(8),
	state_exception varchar(8),
	coverage_code varchar(32),
	veh_age_group_code varchar(8),
	...
	number_of_days numeric(22,0),
	step_value numeric(22,0),
	base_charge numeric(22,0),
	additional_charge numeric(22,0),
	base_limit numeric(22,0),
	...
	user_def_ann_prem numeric(22,0),
	period_number numeric(22,0),
	comp_rt_manipulator varchar(512),
	comp_rt_unt_typ varchar(256)
);

ALTER TABLE mic_policy_aw.rt_mis_cov_ca_loss_use_expense DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_loss_use_expense_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_loss_use_expense ADD CONSTRAINT rt_mis_cov_ca_loss_use_expense_gid PRIMARY KEY (gid);
