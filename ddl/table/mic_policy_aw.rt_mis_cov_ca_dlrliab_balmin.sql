CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_dlrliab_balmin (
	gid numeric(22,0),
	...
	auto_deals_liab_cov numeric(22,0),
	max_premium_liab_loc_num numeric(22,0),
	min_prem_liab_cov_factor numeric(22,0),
	...
	loc_liab_annual_premium numeric(22,0),
	period_number numeric(22,0),
	comp_rt_manipulator varchar(512),
	comp_rt_unt_typ varchar(256)
);

ALTER TABLE mic_policy_aw.rt_mis_cov_ca_dlrliab_balmin DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_dlrliab_balmin_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_dlrliab_balmin ADD CONSTRAINT rt_mis_cov_ca_dlrliab_balmin_gid PRIMARY KEY (gid);
