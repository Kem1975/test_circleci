CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_sup_death_ben (
	gid numeric(22,0),
	...
	supp_death_ben_cov numeric(22,0),
	state varchar(30),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_sup_death_ben DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_sup_death_ben_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_sup_death_ben ADD CONSTRAINT rt_mis_cov_ca_sup_death_ben_gid PRIMARY KEY (gid);
