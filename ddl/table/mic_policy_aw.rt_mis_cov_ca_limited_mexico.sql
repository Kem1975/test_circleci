CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_limited_mexico (
	gid numeric(22,0),
	...
	limited_mexico_cov numeric(22,0),
	state varchar(30),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_limited_mexico DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_limited_mexico_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_limited_mexico ADD CONSTRAINT rt_mis_cov_ca_limited_mexico_gid PRIMARY KEY (gid);
