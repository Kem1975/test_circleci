CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_ha_bal_to_min (
	gid numeric(22,0),
	...
	hired_bor_liab_bal_min numeric(22,0),
	hired_bor_pd_bal_min numeric(22,0),
	...
	hired_bor_pd_bal_min_cov numeric(22,0),
	hba_lb_tkr_bal_min_cov numeric(22,0),
	hba_lb_otr_bal_min_cov numeric(22,0),
	total_hba_premium numeric(22,0),
	sys_start_date date,
	sys_end_date date,
	sys_is_auditable char(1),
	sys_is_split_on_audit char(1),
	hba_lb_mb_frm_bal_min_cov numeric(22,0),
	hba_pd_mb_frm_bal_min_cov numeric(22,0),
	...
	zip_code varchar(15),
	hba_lb_pd_otr_btm_cov numeric(22,0),
	comp_rt_manipulator varchar(512),
	comp_rt_unt_typ varchar(256)
);

ALTER TABLE mic_policy_aw.rt_mis_cov_ca_ha_bal_to_min DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_ha_bal_to_min_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_ha_bal_to_min ADD CONSTRAINT rt_mis_cov_ca_ha_bal_to_min_gid PRIMARY KEY (gid);
