CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_leased_workers (
	gid numeric(22,0),
	...
	leased_workers_cov numeric(22,0),
	state varchar(30),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_leased_workers DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_leased_workers_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_leased_workers ADD CONSTRAINT rt_mis_cov_ca_leased_workers_gid PRIMARY KEY (gid);
