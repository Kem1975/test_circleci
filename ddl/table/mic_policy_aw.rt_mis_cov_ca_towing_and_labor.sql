CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_towing_and_labor (
	gid numeric(22,0),
	...
	veh_towing_and_labor_cov numeric(22,0),
	"limit" numeric(22,0),
	...
	val_per_rating_unit_code varchar(8),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_towing_and_labor DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_towing_and_labor_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_towing_and_labor ADD CONSTRAINT rt_mis_cov_ca_towing_and_labor_gid PRIMARY KEY (gid);
