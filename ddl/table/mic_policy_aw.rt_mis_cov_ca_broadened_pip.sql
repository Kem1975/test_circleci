CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_broadened_pip (
	gid numeric(22,0),
	...
	broadened_pip_loss_cost numeric(22,0),
	added_pip_loss_cost numeric(22,0),
	added_pip_medical_expense numeric(22,0),
	added_pip_work_loss numeric(22,0),
	added_pip_funeral_expenses numeric(22,0),
	added_pip_accidental_death numeric(22,0),
	...
	named_brd_pip_cov numeric(22,0),
	...
	brd_pip_no_nmd_indiv numeric(22,0),
	scl_apip_fst_pty_bnf varchar(128),
	...
	extended_pip_factor numeric(22,0),
	comp_rt_manipulator varchar(512),
	comp_rt_unt_typ varchar(256)
);

ALTER TABLE mic_policy_aw.rt_mis_cov_ca_broadened_pip DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_broadened_pip_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_broadened_pip ADD CONSTRAINT rt_mis_cov_ca_broadened_pip_gid PRIMARY KEY (gid);
