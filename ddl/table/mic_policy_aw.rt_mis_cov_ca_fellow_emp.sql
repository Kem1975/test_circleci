CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_fellow_emp (
	gid numeric(22,0),
	...
	fellow_employee_cov numeric(22,0),
	coverage_type varchar(4),
	person_job_position varchar(512),
	state varchar(30),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_fellow_emp DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_fellow_emp_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_fellow_emp ADD CONSTRAINT rt_mis_cov_ca_fellow_emp_gid PRIMARY KEY (gid);
