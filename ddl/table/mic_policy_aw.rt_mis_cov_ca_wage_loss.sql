CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_wage_loss (
	gid numeric(22,0),
	...
	veh_wage_loss_cov numeric(22,0),
	ha_wage_loss_cov numeric(22,0),
	reg_wage_loss_cov numeric(22,0),
	frf_wage_loss_cov numeric(22,0),
	loc_wage_loss_cov numeric(22,0),
	incr_wageloss_month_limit numeric(22,0),
	incr_wageloss_accdnt_limit numeric(22,0),
	loss_cost numeric(22,0),
	wage_loss_incr_factor numeric(22,0),
	...
	opinfo_frn_non_frn_ftr numeric(22,0),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_wage_loss DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_wage_loss_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_wage_loss ADD CONSTRAINT rt_mis_cov_ca_wage_loss_gid PRIMARY KEY (gid);
