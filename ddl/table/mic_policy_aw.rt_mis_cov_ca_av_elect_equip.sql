CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_av_elect_equip (
	gid numeric(22,0),
	...
	veh_av_data_equip_cov numeric(22,0),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_av_elect_equip DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_av_elect_equip_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_av_elect_equip ADD CONSTRAINT rt_mis_cov_ca_av_elect_equip_gid PRIMARY KEY (gid);
