CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_nol_oth_sc_bi (
	gid numeric(22,0),
	...
	non_own_oth_soc_bi_cov numeric(22,0),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_nol_oth_sc_bi DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_nol_oth_sc_bi_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_nol_oth_sc_bi ADD CONSTRAINT rt_mis_cov_ca_nol_oth_sc_bi_gid PRIMARY KEY (gid);
