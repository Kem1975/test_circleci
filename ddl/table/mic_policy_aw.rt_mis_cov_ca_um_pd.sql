CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_um_pd (
	gid numeric(22,0),
	...
	veh_unins_motorist_pd_cov numeric(22,0),
	drv_unins_motorist_pd_cov numeric(22,0),
	reg_unins_motorist_pd_cov numeric(22,0),
	loc_unins_motorist_pd_cov numeric(22,0),
	...
	territory_grp varchar(3),
	deductible_code varchar(2),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_um_pd DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_um_pd_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_um_pd ADD CONSTRAINT rt_mis_cov_ca_um_pd_gid PRIMARY KEY (gid);
