CREATE TABLE IF NOT EXISTS mic_policy_aw.rt_mis_cov_ca_rental_reim_ma (
	gid numeric(22,0),
	...
	veh_rental_reim_ma_cov numeric(22,0),
...
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_rental_reim_ma DROP CONSTRAINT IF EXISTS rt_mis_cov_ca_rental_reim_ma_gid;
ALTER TABLE mic_policy_aw.rt_mis_cov_ca_rental_reim_ma ADD CONSTRAINT rt_mis_cov_ca_rental_reim_ma_gid PRIMARY KEY (gid);
